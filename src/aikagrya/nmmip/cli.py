...
from .presets import PRESETS, DEFAULT
from .runner import run_trials


def main():
    p = argparse.ArgumentParser(description="Neutral MMIP (N-MMIP)")
    p.add_argument("--preset", choices=PRESETS.keys(), help="128/256/512/1080")
    ...
    p.add_argument("--output", type=str, default=DEFAULT["output"])
